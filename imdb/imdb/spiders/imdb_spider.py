...
class imdbSpider(Spider):
    ...
    start_urls=['http://www.imdb.com/search/title?release_date=2017-01-01,2018-01-01&page=%s&ref_=adv_nxt'% page for page in range(0,3)]
    #start_urls=['http://www.imdb.com/search/title?release_date=2000-01-01,2001-01-01']
